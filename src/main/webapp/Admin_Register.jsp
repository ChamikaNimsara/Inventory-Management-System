  		...
  		<div class="row">
    		<div class="col-2" style="padding-left: 1.5%;">
      			...
      			<ul style="padding-left: 0;"> 
      				...
      				<a href="">
      					<li class="list-group-item" id="Active1"><i class="fa-solid fa-user-plus"></i>  New Admin</li>
      				</a>
      				<a href="getStudent">
    		...
    		<div class="col-10" style=" text-align: center; ">
      			<br><h2 style="text-align: center;">Add New Admin</h2><br><br>
      			<div class="container1">
      				<form action="admininsert" style="width: 640px; text-align: left;" method="post">
      					<div class="mb-3">
						...
						<div style="text-align: center;">
					  	<input type="submit" class="btn btn-lg" id="buttonAdd" value="Register Admin">
      					</div>
      				</form>
      			</div>
    		</div>
