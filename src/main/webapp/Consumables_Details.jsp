	...
	<div class="" style="margin: 0; margin-right: 0; padding-right: 3%;">
  		<div class="row">
    		...
    		<div class="col-10" style=" text-align: center; ">
      			<h2 style="text-align: center;">Consumables</h2><br>
      			<a href="Consumables_Insert.jsp">
      			<button class="btn" type="button" style="background-color: #5837D0; color: white; width: 60%;">Add New Consumables</button>
      			</a><br><br>
      			${consumablesDetails}
    		</div>
  		</div>
