  		...
  		<div class="row">
    		<div class="col-2" style="padding-left: 1.5%;">
      			...
      			<ul style="padding-left: 0;"> 
      				...
      				<a href="getInventory">
      					<li class="list-group-item" id="Active1"><i class="fa-solid fa-hammer"></i>  Inventory</li>
      				</a>
    		...
    		<div class="col-10" style=" text-align: center; ">
      			<br><h2 style="text-align: center;">Add New Inventory</h2><br><br>
      			<div class="container1">
      				<form action="inventoryinsert" style="width: 640px; text-align: left;" method="post">
      				 <div class="row">
   				 		<div class="col">
      					<div class="mb-3">
    						<label class="form-label" style="text-align: left;">Inventory ID</label>
  						...
  						<div class="mb-3">
    						<label class="form-label">GRN_REF</label>
    						<input type="text" class="form-control" id="GRN_REF">
						</div>
						</div>
						<div class="col">
						<div class="mb-3">
    						<label class="form-label">SB_Update</label>
    						<input type="text" class="form-control" id="SB_Update">
						</div>
						<div class="mb-3">
